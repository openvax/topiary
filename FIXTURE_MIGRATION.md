...
uses the published Osteosarc 0.2.3 release. New recipes can use the
...
```sh
python -m scripts.generate_sid_fixtures --source-directory tests/data \
  --cache-root CACHE --offline --output NEW_DIRECTORY
```
