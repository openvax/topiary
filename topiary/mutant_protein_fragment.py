...
def varcode_effect_to_mutant_protein_fragment(
    ...
    return MutantProteinFragment(
        ...
        full_protein_length=len(mutant_protein_sequence),
...
def varcode_effects_to_mutant_protein_fragments(effects, padding_around_mutation):
    """
    ...
    mapping each effect to MutantProteinFragment object.
    """
    effects_to_mutant_protein_fragments_dict = {}
    for effect in effects:
        mutant_protein_fragment = varcode_effect_to_mutant_protein_fragment(
            effect,
            padding_around_mutation=padding_around_mutation)
        if mutant_protein_fragment is None:
            continue
        effects_to_mutant_protein_fragments_dict[effect] = mutant_protein_fragment
    return effects_to_mutant_protein_fragments_dict
